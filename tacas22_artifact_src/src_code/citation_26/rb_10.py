...
# N = 20
# start_states = []
# goals = ['s_19_16', 's_19_17', 's_19_18']
# start_set = ['s_0_0',  's_0_1', 's_0_2']

# # N = 40
# start_states = []
# goals = ['s_39_36', 's_39_37', 's_39_38']
# start_set = ['s_0_0',  's_0_1', 's_0_2']
...
end1 = time.time() # end getSMT


start2 = time.time()
res = solver.check()
end2 = time.time()
print(" Grid size = " + str(N) + "^2")
print(" getsmt:     " + str(end1 - start1)[:5] + " sec")
print(" Z3 solving: " + str(end2 - start2)[:5] + " sec")
print(" ")

# print(" Init state robustness solved in " + str(end2 - start2) + " sec")
strategy = []
strategy1 = []
if res == sat:
    m = solver.model()
